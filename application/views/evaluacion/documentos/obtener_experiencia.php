...
<div class="col-md-12 col-sm-12">
    ...
    <div class="col-md-8 col-sm-8">
        <div>SI<?php echo form_radio('requisitos_minimo_exp', "1", false, 'class="requisitos_minimo"') ?></div>
        <div>NO<?php echo form_radio('requisitos_minimo_exp', "0", false, 'class="requisitos_minimo"') ?></div>
        <br>
        Observación:<br>
        <textarea id="tex_requisitos_minimo_exp" name="tex_requisitos_minimo_exp" style="width: 100%"></textarea>
    </div>
    <div class="col-md-2 col-sm-2"></div>
</div>